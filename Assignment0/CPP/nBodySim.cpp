...
int main()
{
    ...
    int chargeElectron  = -1; // in units of elementary charge
    int chargeProton    = +1; // in units of elementary charge
    double massElectron = 9.109e-31; // in kg
    double massProton   = 1.673e-27; // in kg
    ...
    pSystem.addParticle(new Particle(chargeElectron,massElectron,0,+0.5,0));
    pSystem.addParticle(new Particle(chargeElectron,massElectron,0,-0.5,0));
    ...
    pSystem.clear();
    pSystem.addParticle(new Particle(chargeProton,massProton,0,0,0));
    pSystem.addParticle(new Particle(chargeElectron,massElectron,0,1,0));
    ...
    pSystem.clear();
    pSystem.addParticle(new Particle(chargeProton,massProton,0,0,0));
    pSystem.addParticle(new Particle(chargeElectron,massElectron,0,1,0,15.9,0,0));
    ...
    pSystem.clear();
    pSystem.addParticle(new Particle(chargeProton,massProton,1,0,0));
    pSystem.addParticle(new Particle(chargeElectron,massElectron,0,+1,0));
    pSystem.addParticle(new Particle(chargeElectron,massElectron,0,-1,0));
    ...
    pSystem.clear();
    pSystem.addParticle(new Particle(chargeElectron,massElectron,-1,+1,0));
    pSystem.addParticle(new Particle(chargeElectron,massElectron,+1,+1,0));
    pSystem.addParticle(new Particle(chargeElectron,massElectron,-1,-1,0));
    pSystem.addParticle(new Particle(chargeElectron,massElectron,+1,-1,0));
    pSystem.addParticle(new Particle(chargeProton,massProton,-1,0,0));
    pSystem.addParticle(new Particle(chargeProton,massProton,0,+1,0));
    pSystem.addParticle(new Particle(chargeProton,massProton,+1,0,0));
    pSystem.addParticle(new Particle(chargeProton,massProton,0,-1,0));
    ...
    pSystem.clear();
    pSystem.addParticle(new Particle(chargeElectron,massElectron,-2,+1,0,10,-20,0));
    pSystem.addParticle(new Particle(chargeProton,massProton,-1,+1,0));
    pSystem.addParticle(new Particle(chargeProton,massProton,+1,+1,0));
    pSystem.addParticle(new Particle(chargeProton,massProton,-1,-1,0));
    pSystem.addParticle(new Particle(chargeProton,massProton,+1,-1,0));
